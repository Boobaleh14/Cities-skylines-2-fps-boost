# Cities: Skylines 2 - FPS Boost & Stutter Fix

This is a basic engine config tweak to help reduce micro-stutters and stabilize frametimes in CS2. 

### Basic Fix (Manual Edit):
If you want to tweak things yourself, you can try adjusting the volumetric and depth of field parameters in your local settings file to lower rendering overhead.

### 🚀 Get the Full Optimized Config
